...
| D19 | A credencial do dispositivo está embutida em claro no APK publicado em repositório público | Segurança | 5 | 5 | 3 | 30 | **RISCO ACEITO** em 2026-09-03 por Gabriel Quental, ver D-021 em `docs/DECISIONS.md`. Dispositivo sob controle físico e rede em piloto; mitigar agora custaria mais que o risco. Vira detecção em vez de prevenção, com gatilhos explícitos de reabertura |
| D20 | `apps/android-sensor` é código morto que aparenta ser o sensor de produção | Android/Estratégia | 3 | 4 | 2 | 28 | novo em 2026-09-03: decidir entre remover, marcar como experimento ou promover a substituto do probe |
